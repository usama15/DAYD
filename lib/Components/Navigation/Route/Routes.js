...
import SubmitHistory from '../../../Packages/History/SubmitHistory';
import PatientHistory from '../../../Packages/History/PatientHistory';
    ...
    render() {
        return (
            <Stack.Navigator
                ...
                />
                <Stack.Screen
                    name={Routeskey.SUBMITHISTORY}
                    component={SubmitHistory}
                    options={{ headerShown: false }}
                />
                <Stack.Screen
                    name={Routeskey.PATIENTHISTORY}
